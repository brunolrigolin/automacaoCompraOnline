...
class PesquisareAdicionarnoCarrinho {
	@Given("Procurar um produto e adicionar no carrinho")
	def procurareAdicionarCarrinho() {
	}

	@When("Fazer login com (.*) e (.*) e procurar (.*) na loja")
	def procurarProduto(String username, String password, String produto) {
		WebUI.openBrowser('')
